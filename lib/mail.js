...
async function getEmailSettings() {
  try {
    ...
    return {
      ...
      supportPhone: settingsMap.branding?.supportPhone || '(619) 625-6148',
      ...settingsMap.email
    }
  } catch (error) {
...
export async function sendWelcomeEmail(email, name) {
  ...
  const supportPhone = settings.supportPhone || '(619) 625-6148'
      ...
      <div style="font-family: 'Inter', sans-serif, system-ui; max-width: 600px; margin: 0 auto; padding: 40px 20px; background-color: #ffffff;">
        ...
        <div style="color: #334155; line-height: 1.6; font-size: 16px;">
          ...
          <p style="margin-bottom: 24px;">
            We're excited that you signed up for a free trial of <strong>${appName}</strong>! 
