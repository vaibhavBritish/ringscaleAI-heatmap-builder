    ...
    html: `
      <div style="font-family: 'Inter', sans-serif, system-ui; max-width: 600px; margin: 0 auto; padding: 40px 20px; background-color: #ffffff;">
        ...
        <div style="color: #334155; line-height: 1.6; font-size: 16px;">
          ...
          <p style="margin-bottom: 32px;">
            To dive deeper into your competitors, local rankings, and full heatmap analytics, click the link below to view your complete audit report and download it as a PDF!
          </p>
          
          <!-- CTA -->
          <div style="text-align: left; margin-bottom: 24px;">
            <a href="${publicAuditUrl}" style="display: inline-block; padding: 14px 32px; background-color: #2563eb; color: #ffffff; text-decoration: none; font-weight: 700; border-radius: 8px; font-size: 16px; box-shadow: 0 4px 6px -1px rgba(37, 99, 235, 0.2);">View Full Audit</a>
          </div>
