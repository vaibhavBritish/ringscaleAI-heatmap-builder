...
async function getSupportPhone(email) {
  try {
    ...
    if (user && user.phone) {
      ...
      // If phone starts with +91 or is 12 digits starting with 91 or is exactly 10 digits
      if (
      ...
      // If the phone has a different country code, treat as out of India
      if (user.phone.startsWith('+') && !user.phone.startsWith('+91')) {
        return '+14372913091' // Out of India clients
      }
      
      // If it's a 11-digit number starting with 1 (US/Canada)
  ...
  // Default to Indian number for new signups or unknown
  return '+917827494533'
}
      ...
      content: `
          ...
          <div style="background: #f8fafc; padding: 24px; border-radius: 12px; border: 1px solid #e2e8f0; margin-bottom: 32px;">
            ...
            <div style="border-top: 1px solid #e2e8f0; padding-top: 16px;">
              ...
              <p style="margin: 8px 0 4px 0; color: #334155; font-size: 15px;"><strong>Email:</strong> ${email}</p>
              <p style="margin: 4px 0; color: #334155; font-size: 15px;"><strong>Temporary Password:</strong> <code style="background-color: #f1f5f9; padding: 4px 8px; border-radius: 4px; font-family: monospace; font-size: 16px; border: 1px solid #e2e8f0;">${password}</code></p>
              <p style="margin: 12px 0 0 0; color: #ef4444; font-size: 13px; font-weight: 600;">⚠️ Please change your password immediately after logging in.</p>
            </div>
          </div>
